...
<div class="content">
    <x-dtc.page-header title="Requirements" subtitle="Track the documents required for your enrollment application." icon="fa-folder-open" />
</div>
@stop
...
<div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <div class="card h-100 mb-0">
                <div class="card-body d-flex align-items-center gap-3">
                    <div class="dtc-stat-icon {{ $doc ? 'is-success' : 'is-warning' }}"><i class="fas {{ $doc ? 'fa-check' : 'fa-file-upload' }}"></i></div>
    ...
    @empty
        <div class="col-12"><x-dtc.empty-state icon="fa-folder-open" title="No requirements configured" /></div>
    @endforelse
</div>
@if($application)
...
@else
<div class="card"><div class="card-body"><x-dtc.empty-state icon="fa-file-alt" title="No application linked to this account" message="Please contact the Registrar if you expect an application to be available." /></div></div>
@endif
</div>
@stop
