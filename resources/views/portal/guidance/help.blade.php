...
<div class="content">
    <x-dtc.page-header title="Help Center" subtitle="Quick answers for enrollment, requirements, appointments, and payments." icon="fa-question-circle" />
</div>
@stop
...
<div class="col-lg-6 mb-3"><div class="card h-100 mb-0"><div class="card-body d-flex gap-3"><div class="dtc-stat-icon"><i class="fas {{ $item[2] }}"></i></div><div><div class="font-weight-bold">{{ $item[0] }}</div><div class="text-muted small mt-1">{{ $item[1] }}</div></div></div></div></div>
@endforeach
</div>
