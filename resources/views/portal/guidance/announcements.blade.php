...
<div class="content">
    <x-dtc.page-header title="Announcements" subtitle="Your latest DTC EMS updates and notices." icon="megaphone" />
</div>
@stop
...
@empty
<x-dtc.empty-state icon="megaphone" title="No announcements yet" message="System announcements will appear here." />
@endforelse
