...
<div class="content">
    <x-dtc.page-header title="Payments" subtitle="Review your enrollment fees and payment verification status." icon="fa-credit-card" />
</div>
@stop
...
@empty
<tr><td colspan="5"><x-dtc.empty-state icon="fa-credit-card" title="No payment records" message="Your payment history will appear after an enrollment is created." /></td></tr>
@endforelse
